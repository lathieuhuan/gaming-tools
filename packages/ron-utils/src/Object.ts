...
export class Object_ {
  //
  static set<TObj, const TPath extends NestedPath<TObj> = NestedPath<TObj>>(
    object: TObj,
    path: NoInfer<TPath>,
  ...
  static extract<TObject, TKey extends keyof TObject = keyof TObject>(obj: TObject, keys: TKey[]) {
...
type NestedPath<TObj> =
  TObj extends Array<infer TItem>
