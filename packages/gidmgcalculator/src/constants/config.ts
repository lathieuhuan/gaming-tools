...
export const DOWNLOAD_DATA_VERSION = 6;
export const PERSISTED_DATA_VERSION = 7;
export const LEGACY_EXPORTED_SETUP_VERSION = "3";
export const EXPORTED_SETUP_VERSION = "4";
export const MINIMUM_SYSTEM_VERSION = "3.49.0";
