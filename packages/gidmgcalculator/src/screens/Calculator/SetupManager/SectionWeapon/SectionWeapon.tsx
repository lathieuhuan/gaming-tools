...
import { updateWeapon } from "@Store/calculator/actions";
import { selectActiveCharacter } from "@Store/calculator/selectors";
      ...
      <div className="ml-2 overflow-hidden space-y-1">
        ...
        <div className="pl-1 flex items-center flex-wrap">
          ...
          <VersatileSelect
            ...
            value={weapon.level}
            onChange={(value) => updateWeapon({ level: value as Level })}
          />
        </div>
        ...
        {rarity >= 3 && (
          <div className="pl-1 flex items-center flex-wrap">
            ...
            <VersatileSelect
              ...
              value={weapon.refi}
              onChange={(value) => updateWeapon({ refi: +value })}
            />
          </div>
        )}
      </div>
