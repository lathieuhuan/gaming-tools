...
import { removeArtifact, updateArtifact } from "@Store/calculator/actions";
    ...
    <div className="pt-4 px-2 space-y-2" onDoubleClick={() => console.log(artifact)}>
      <div className="pl-1 flex items-start gap-4">
        <ArtifactLevelSelect
          ...
          onChangeLevel={(level) => updateArtifact(artifact.type, { level })}
        />
        ...
        <div className="w-full flex flex-col">
          {artifact.type === "flower" || artifact.type === "plume" ? (
            ...
            <VersatileSelect
              ...
              value={mainStatType}
              onChange={(mainStatType) => updateArtifact(artifact.type, { mainStatType })}
            />
          )}
      ...
      <ArtifactSubstatsControl
        ...
        onChangeSubStat={(index, changeInfo) => {
          updateArtifact(artifact.type, { subStat: { index, ...changeInfo } });
        }}
      />
