...
import { CloseButton, InputNumber, Modal, Button } from "rond";
...
function isBuffCtrl(ctrl: CustomBuffCtrl | CustomDebuffCtrl): ctrl is CustomBuffCtrl {
...
export function CustomModifiers({ isBuffs }: CustomModifiersProps) {
