...
import type { UserTeammate } from "@/models/userdb";
...
function SetupViewCore({
  ...
  const { data: mainData, weapon, artifact } = main;
  ...
  const handleSwitchTeammate = (teammate: UserTeammate) => {
