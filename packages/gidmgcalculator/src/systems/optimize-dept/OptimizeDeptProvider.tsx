...
import { OptimizeSystem, OptimizeSystemContext } from "./context";
import { useOptimizerManager } from "./hooks";

// Components
import { FrontDesk, FrontDeskProps } from "./components/FrontDesk";
import { LoadReporter } from "./components/LoadReporter";
import { OptimizeIntro, OptimizeIntroProps } from "./components/OptimizeIntro";
...
export function OptimizeDeptProvider(props: { children: ReactNode }) {
  ...
  return (
    <OptimizeSystemContext.Provider value={system}>
      ...
      <LoadReporter expectedSetupIds={state.expectedSetupIds} afterChecking={() => system.expectSetups([])} />
