...
import { CharacterCalc, CharacterReadData, GeneralCalc } from "@Src/calculation/common";
import {
...
import { AttackAlterer } from "../AttackAlterer";
...
export class InputProcessor {
  ...
  constructor(
    ...
    this.characterData = new CharacterReadData(this.character, data.appCharacters, this.party);
  ...
  getResistances(target: Target) {
    ...
    const resistReductCtrl = new ResistReductionControl(characterData, this.tracker);
