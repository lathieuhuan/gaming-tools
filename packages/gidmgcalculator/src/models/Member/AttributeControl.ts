...
export class AttributeControl {
  ...
  init(member: Member) {
    ...
    // ===== Ascension stats =====
    {
      ...
      const multiplier = ascension > 2 ? ascension - 2 : 0;
      const bonusValue = statBonus.value * multiplier;

      this._add(statBonus.type, bonusValue, "Character ascension stat");
    }
  ...
  /** Get stat value before finalizing */
