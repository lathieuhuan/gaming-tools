...
export class CalcCharacter<
  ...
  >
  extends Character<TWeapon, TArtifact>
  implements ICalcCharacter<TWeapon, TArtifact>, ITeamMember<TTeam>
{
  ...
  constructor(
    info: CalcCharacterConstructInfo<TWeapon, TArtifact>,
  ...
  getTotalAttr(key: AttributeStat | "base_atk", stableOnly = false) {
